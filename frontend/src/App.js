          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="flex items-center justify-center h-12 w-12 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-lg shadow-sm text-white hover:shadow-md transition-shadow"
              ...
              <button
                ...
                className="flex items-center justify-center h-12 w-12 bg-gradient-to-br from-purple-500 to-pink-600 rounded-lg shadow-sm text-white hover:shadow-md transition-shadow"
                title="Sync History"
              >
              ...
              <button
                ...
                className="flex items-center justify-center h-12 w-12 bg-gradient-to-br from-green-500 to-teal-600 rounded-lg shadow-sm text-white hover:shadow-md transition-shadow"
                title="Audit Logs"
              >
              ...
              <button
                ...
                className="flex items-center justify-center h-12 w-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg shadow-sm text-white hover:shadow-md transition-shadow"
                title="Settings"
              >
